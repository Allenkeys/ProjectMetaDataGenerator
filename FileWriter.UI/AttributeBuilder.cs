...
namespace ProjectMetaDataGenerator.CustomAttributes
{
    public class AttributeBuilder
    {
        ...
        {
            DocumentAttribute documentAttribute = (DocumentAttribute)type.GetCustomAttribute(typeof(DocumentAttribute), true);
        ...
        public static void DisplayConstructorAttr(Type type)
        {
            ...
            {
                var documentAttribute = (DocumentAttribute)constructor.GetCustomAttribute(typeof(DocumentAttribute), true);
        ...
        public static void DisplayPropAttr(Type classtype)
        {
            ...
            {
                var documentAttribute = (DocumentAttribute)property.GetCustomAttribute(typeof(DocumentAttribute), true);
        ...
        public static void DisplayMethodAttr(Type classtype)
        {
            ...
            {
                var documentAttribute = (DocumentAttribute)method.GetCustomAttribute(typeof(DocumentAttribute), true);
